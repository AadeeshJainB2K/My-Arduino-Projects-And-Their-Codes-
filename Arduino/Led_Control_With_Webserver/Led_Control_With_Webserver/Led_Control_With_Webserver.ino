...
void loop() {
  ...
  client.println("<div class='header' style = 'margin: 0;padding: 0;box-sizing: border-box;height: 25%;width: 100%;background: rgba(255, 255, 255, 0.05);box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37);-webkit-backdrop-filter: blur(1px);backdrop-filter: blur(2px);border-radius: 7vh;border: 1px solid rgba(255, 255, 255, 0.18);color: #2222ff;display: flex;align-items: center;justify-content: center;font-size: 3vh;font-weight: 100;z-index: 3;'>");
